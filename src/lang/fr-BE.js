export default {
  "notice": "La méthodologie de calcul du score (le 'matching') est décrite ici [http://www.wecitizens.be/docs-en/Q22-Matching_methodology.pdf]\nDisclaimer:\nNousCitoyens ne peut pas garantir la sincérité ni la fiabilité des réponses des candidats. Le 'matching' n'est qu'une indication, parmi d'autres pour se former un jugement : les projets, les compétences et l'intégrité du candidat.\nIl est recommandé de visiter le profil du candidat en cliquant sur son nom.\nTenez aussi compte que votre commune connaît des enjeux qui lui sont propres et qui ne sont pas repris dans cet outil. \nAvec votre soutien, nous espérons pouvoir vous aider encore mieux lors des élections fédérales, régionales et européenne de mai 2019.",
  "home": {
    "cta": "Je fais le test !",
